                               ...
                               ...)
{
  ...
  structure(list(labels = labels,
                 ...
                 lower = lower,
                 mar = mar,
                 title = ifelse(missing(title), NA, title),
                 legend = ifelse(missing(legend), NA, legend),
                 ...
                 graph.pos = graph.pos,
                 axisList = axisList,
                 boxsize = ifelse(missing(boxsize), NA, boxsize),
                 is.summary = is.summary,
                 org_mean = org_mean,
                 ...
                 org_lower = org_lower,
                 org_upper = org_upper,
                 line.margin = ifelse(missing(line.margin), NA, line.margin),
                 fn.legend = ifelse(missing(fn.legend), NA, fn.legend),
                 fn.ci_sum = fn.ci_sum,
                 fn.ci_norm = fn.ci_norm,
                 lty.ci = lty.ci,
                 ci.vertices.height = ci.vertices.height,
                 ci.vertices = ifelse(missing(ci.vertices), NA, ci.vertices),
                 lwd.zero = ifelse(missing(lwd.zero), NA, lwd.zero),
                 lwd.ci = ifelse(missing(lwd.ci), NA, lwd.ci),
